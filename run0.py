...
model = AutoEncoderRNN(input_size, hidden_size, output_size, num_layers = 1, seq_len = sequence_length, batch_size = batch_size, batch_first=True)
...
with open('trained_models/model12_4-28AM.pickle', 'wb') as f:
    pickle.dump(model, f)
with open('trained_models/loss12_4-28AM.pickle', 'wb') as f:
